...
\begin{shaded}
\begin{remark}[Ex falso quad libet]
The idea that $F \implies T$ is called '\textbf{ex falso quad libet}', i.e. from a false assumption, anything can follow. This principle is solidified by the below theorem.
\end{remark}
